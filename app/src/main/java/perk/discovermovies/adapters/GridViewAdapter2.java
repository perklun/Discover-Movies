 ...
 */
public class GridViewAdapter2 extends ArrayAdapter<Movie2.Result> {

    public GridViewAdapter2(Context context, List<Movie2.Result> objects) {
        super(context, R.layout.movie_thumbnail, objects);
    }

    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        Movie2.Result m = getItem(position);
        if(convertView == null){
